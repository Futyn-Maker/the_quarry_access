...
| `speech/Sounds`        | Short cues played through the sound card (confirmation and failure tones, the four directions of a quick-time event, blips whose pitch follows a ring or a bar), so they reach the player at once, while a held key keeps the reader silent or the reader is busy. |
