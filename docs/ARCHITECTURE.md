...
| `speech/Sounds`        | Short cues played through the sound card (a confirmation tone when a choice commits), so they reach the player while a held key keeps the reader silent.                                                                       |
